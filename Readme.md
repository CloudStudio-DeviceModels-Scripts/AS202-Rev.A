...
# Parsing + Configuration Script – AS202 - Rev. A

This **Parsing + Configuration** script is designed for the **AS202** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AS202 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AS202** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
